...
<form method="post">
    ชื่อหนังสือ: <input type="text" name="book_name" value="<?= htmlspecialchars($b['book_name']) ?>" required><br><br>
    ผู้แต่ง: <input type="text" name="author" value="<?= htmlspecialchars($b['author']) ?>" required><br><br>
    ประเภท: <input type="text" name="category" value="<?= htmlspecialchars($b['category']) ?>" required><br><br>
